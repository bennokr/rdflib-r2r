...
```
{'ProductType': '<http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/ProductType8>', 'Country': '<http://downlode.org/rdf/iso-3166/countries#KR>'}
```
...
WHERE anon_2.product = anon_1.product
  AND NOT (EXISTS
             (SELECT anon_3.s,
              ...
              WHERE anon_3.s = '<' || 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Vendor' || replace(replace(replace(replace(replace(replace(CAST(anon_4.vendor AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || '>'
                AND anon_3.o = '<http://downlode.org/rdf/iso-3166/countries#KR>'
