...
_:Student#1 <http://example.com/base/Student#Name> "Fernando" .
_:Student#1 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student> .
_:Student#2 <http://example.com/base/Student#ID> "30"^^<http://www.w3.org/2001/XMLSchema#integer> .
_:Student#2 <http://example.com/base/Student#Name> "David" .
