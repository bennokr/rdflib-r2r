...
SELECT anon_1.s AS s,
       ...
       anon_1.o AS o
FROM
  (SELECT '<Student_Sport/ID_Student=' || replace(replace(replace(replace(replace(replace(CAST("Student_Sport"."ID_Student" AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || '>' AS s,
          '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>' AS p,
          '<http://example.com/base/Student_Sport>' AS o,
          NULL AS g
   FROM "Student_Sport"
   UNION ALL SELECT '<Student_Sport/ID_Student=' || replace(replace(replace(replace(replace(replace(CAST("Student_Sport"."ID_Student" AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || '>' AS s,
...
## Raw ouput triples
```
<http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ID_Sport> "110"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ID_Student> "10"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ref-ID_Sport> _:Sport#0 .
<http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ref-ID_Student> _:Student#0 .
<http://example.com/base/Student_Sport/ID_Student=10> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Sport> "111"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Sport> "112"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Student> "11"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Student> "11"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Sport> _:Sport#1 .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Sport> _:Sport#2 .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Student> _:Student#1 .
<http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Student> _:Student#1 .
<http://example.com/base/Student_Sport/ID_Student=11> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
<http://example.com/base/Student_Sport/ID_Student=11> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
<http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ID_Sport> "111"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ID_Student> "12"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ref-ID_Sport> _:Sport#1 .
<http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ref-ID_Student> _:Student#2 .
<http://example.com/base/Student_Sport/ID_Student=12> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
...
+ <http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ID_Sport> "110"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ID_Student> "10"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ref-ID_Sport> _:cb6e1aa4c97a9b10b6b827c6a840a138009e3231113cc3aaf61f93fbda7a6abcd6 .
+ <http://example.com/base/Student_Sport/ID_Student=10> <http://example.com/base/Student_Sport#ref-ID_Student> _:cb3f08ac56775877df5f632d4deef2d02b706557970c1e99ffa8a55661bb642ecb .
+ <http://example.com/base/Student_Sport/ID_Student=10> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
...
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Sport> "112"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ID_Student> "11"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Sport> _:cb557c33a7da17af984a4839a93851ccdf4d15edbb98acd27977f648d699ac020 .
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Sport> _:cb7b38033ef073fa88b1feafd875ee56b34ebff619b3960bef747e34b863cbf0c3 .
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://example.com/base/Student_Sport#ref-ID_Student> _:cb507694a67037aab92d1975098d507a125a10a527a190f6024b1ae22ab3d2cd .
+ <http://example.com/base/Student_Sport/ID_Student=11> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
...
+ <http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ID_Sport> "111"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ID_Student> "12"^^<http://www.w3.org/2001/XMLSchema#integer> .
+ <http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ref-ID_Sport> _:cb557c33a7da17af984a4839a93851ccdf4d15edbb98acd27977f648d699ac020 .
+ <http://example.com/base/Student_Sport/ID_Student=12> <http://example.com/base/Student_Sport#ref-ID_Student> _:cb0 .
+ <http://example.com/base/Student_Sport/ID_Student=12> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
