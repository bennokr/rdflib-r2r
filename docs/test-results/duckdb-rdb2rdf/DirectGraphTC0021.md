...
<http://example.com/base/Target/PK=1010;PK=1010> <http://example.com/base/Target#key1attr1> "K1A11" .
<http://example.com/base/Target/PK=1010;PK=1010> <http://example.com/base/Target#key1attr2> "K1A21" .
<http://example.com/base/Target/PK=1010;PK=1010> <http://example.com/base/Target#key2attr1> "K2A11" .
<http://example.com/base/Target/PK=1010;PK=1010> <http://example.com/base/Target#key2attr2> "K2A21" .
<http://example.com/base/Target/PK=1010;PK=1010> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Target> .
<http://example.com/base/Target/PK=1011;PK=1011> <http://example.com/base/Target#PK> "1011"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Target/PK=1011;PK=1011> <http://example.com/base/Target#key1attr1> "K1A12" .
<http://example.com/base/Target/PK=1011;PK=1011> <http://example.com/base/Target#key1attr2> "K1A22" .
<http://example.com/base/Target/PK=1011;PK=1011> <http://example.com/base/Target#key2attr2> "K2A22" .
<http://example.com/base/Target/PK=1011;PK=1011> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Target> .
<http://example.com/base/Target/PK=1012;PK=1012> <http://example.com/base/Target#PK> "1012"^^<http://www.w3.org/2001/XMLSchema#integer> .
<http://example.com/base/Target/PK=1012;PK=1012> <http://example.com/base/Target#key1attr1> "K1A13" .
<http://example.com/base/Target/PK=1012;PK=1012> <http://example.com/base/Target#key1attr2> "K1A23" .
<http://example.com/base/Target/PK=1012;PK=1012> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Target> .
```
