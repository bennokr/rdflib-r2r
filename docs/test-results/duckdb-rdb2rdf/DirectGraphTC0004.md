...
## Raw ouput triples
```
_:Student_Sport#0 <http://example.com/base/Student_Sport#Sport> "Tennis" .
_:Student_Sport#0 <http://example.com/base/Student_Sport#Student> "Venus" .
_:Student_Sport#0 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://example.com/base/Student_Sport> .
```
