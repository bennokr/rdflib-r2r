              ...
              (SELECT anon_11.score AS score,
               ...
               FROM
                 (SELECT anon_12.score AS score,
                  ...
                  FROM
                    (SELECT anon_13.rating1 AS score,
                            CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_13.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
                     FROM
                       (SELECT anon_14.rating1 AS rating1,
                               anon_14.nr AS nr
                        FROM
                          (SELECT review.rating1 AS rating1,
                                  review.nr AS nr
                           FROM review) AS anon_14) AS anon_13
                     UNION ALL SELECT anon_15.rating2 AS score,
                                      CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_15.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
                     FROM
                       (SELECT anon_16.rating2 AS rating2,
                               anon_16.nr AS nr
                        FROM
                          (SELECT review.rating2 AS rating2,
                                  review.nr AS nr
                           FROM review) AS anon_16) AS anon_15) AS anon_12
                  UNION ALL SELECT anon_17.rating3 AS score,
                                   CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_17.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
                  FROM
                    (SELECT anon_18.nr AS nr,
                            anon_18.rating3 AS rating3
                     FROM
                       (SELECT review.nr AS nr,
                               review.rating3 AS rating3
                        FROM review) AS anon_18) AS anon_17) AS anon_11
               UNION ALL SELECT anon_19.rating4 AS score,
                                CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_19.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
               FROM
                 (SELECT anon_20.rating4 AS rating4,
                         anon_20.nr AS nr
                  FROM
                    (SELECT review.rating4 AS rating4,
                            review.nr AS nr
     ...
     (SELECT anon_24.score AS score,
      ...
      FROM
        (SELECT anon_25.score AS score,
         ...
         FROM
           (SELECT anon_26.rating1 AS score,
                   CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_26.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
            FROM
              (SELECT anon_27.nr AS nr,
                      anon_27.rating1 AS rating1
               FROM
                 (SELECT review.nr AS nr,
                         review.rating1 AS rating1
                  FROM review) AS anon_27) AS anon_26
            UNION ALL SELECT anon_28.rating2 AS score,
                             CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_28.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
            FROM
              (SELECT anon_29.rating2 AS rating2,
                      anon_29.nr AS nr
               FROM
                 (SELECT review.rating2 AS rating2,
                         review.nr AS nr
                  FROM review) AS anon_29) AS anon_28) AS anon_25
         UNION ALL SELECT anon_30.rating3 AS score,
                          CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_30.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
         FROM
           (SELECT anon_31.rating3 AS rating3,
                   anon_31.nr AS nr
            FROM
              (SELECT review.rating3 AS rating3,
                      review.nr AS nr
               FROM review) AS anon_31) AS anon_30) AS anon_24
      UNION ALL SELECT anon_32.rating4 AS score,
                       CAST('<' AS VARCHAR) || CAST('http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/Review' AS VARCHAR) || replace(replace(replace(replace(replace(replace(CAST(anon_32.nr AS VARCHAR), ' ', '%20'), '/', '%2F'), '(', '%28'), ')', '%29'), ',', '%2C'), ':', '%3A') || CAST('>' AS VARCHAR) AS review
      FROM
        (SELECT anon_33.nr AS nr,
                anon_33.rating4 AS rating4
         FROM
           (SELECT review.nr AS nr,
